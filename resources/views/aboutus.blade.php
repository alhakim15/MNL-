...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@400;700&family=Poiret+One&display=swap" rel="stylesheet">
  ...
  <section class="tentang">
    <div class="tentang-box">
      ...
      <div class="text">
        ...
        <p>PT Mutiara Nasional Line didirikan pada tahun 1995 sebagai agen operasional kapal. Pada tahun 2013, perusahaan resmi menjadi perusahaan pelayaran dengan satu kapal. Berkat komitmen dan inovasi, kini PT Mutiara Nasional Line mengoperasikan enam kapal milik sendiri dan satu kapal sewaan.</p>
        <p>Armada perusahaan meliputi KM Mutiara Sejahtera, KM Karunia Permai, KM Lintas Bahari 12, KM Lintas Bahari 20, KM Bahari 28, KM Kota Nabire, dan KM Vidi (kapal sewaan). Perkembangan ini mencerminkan dedikasi perusahaan dalam menyediakan layanan pelayaran profesional di industri maritim.</p>
        <p>Logo perusahaan bergambar bendera merah bertuliskan "MNL" putih melambangkan keberanian, integritas, dan profesionalisme — nilai-nilai utama yang menjadi fondasi operasional perusahaan.</p>
      </div>
    </div>
  </section>
