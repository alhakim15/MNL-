...
<body>
  ...
  <main>
      ...
      <div class="tentang-box">
        ...
        <div class="text">
          ...
          <p>PT Mutiara Nasional Line didirikan pada tahun 1995 sebagai agen operasional kapal. Pada tahun 2013,
            perusahaan resmi menjadi perusahaan pelayaran dengan satu kapal. Berkat komitmen dan inovasi, kini PT
            Mutiara
            Nasional Line mengoperasikan enam kapal milik sendiri dan satu kapal sewaan.</p>
          <p>Armada perusahaan meliputi KM Mutiara Sejahtera, KM Karunia Permai, KM Lintas Bahari 12, KM Lintas Bahari
            20,
    ...
    <section class="features">
      ...
      <div class="feature-box"> <img src="{{asset('Gambar/order-tracking.png')}}" alt="Tracking Canggih">
        <div class="feature-text">
      ...
      <div class="feature-box"> <img src="{{asset('Gambar/responsible.png')}}" alt="Pelayanan Pelanggan">
        <div class="feature-text">
